...
action_tutorials_cpp::FibonacciActionServer::handle_goal(
    ...
    std::shared_ptr<const action_tutorials_interfaces::action::Fibonacci::Goal>
        goal) {
...
void action_tutorials_cpp::FibonacciActionServer::execute(
  ...
  std::shared_ptr<action_tutorials_interfaces::action::Fibonacci_Feedback>
      feedback = std::make_shared<
          action_tutorials_interfaces::action::Fibonacci::Feedback>();
  std::vector<int32_t, std::allocator<int32_t>>& sequence =
      feedback->partial_sequence;
  sequence.push_back(0);
  sequence.push_back(1);
  std::shared_ptr<action_tutorials_interfaces::action::Fibonacci_Result>
